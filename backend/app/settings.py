...
ALLOWED_HOSTS = os.environ.get("ALLOWED_HOSTS", "localhost,127.0.0.1,case-detector-2ne7.onrender.com,.onrender.com").split(",")
...
CSRF_TRUSTED_ORIGINS = [
    ...
    'https://case-detector-2ne7.onrender.com',
    'http://localhost:8000',
    'http://127.0.0.1:8000',
]
